package com.rameshv.classicblue.bluetooth_classic;
...
public class BluetoothClassicPlugin implements FlutterPlugin, MethodCallHandler,RequestPermissionsResultListener, ActivityResultListener, ViewDestroyListener,ActivityAware {
  ...
  /// when the Flutter Engine is detached from the Activity
   ...
   private static final String PLUGIN_NAMESPACE = "bluetooth_classic";
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    // channel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "bluetooth_classic");
    // channel.setMethodCallHandler(this);
    pluginBinding  = flutterPluginBinding;
  }


  public BluetoothClassicPlugin() {}
  ...
  public void onAttachedToActivity(ActivityPluginBinding binding) {
        setup(null,binding,(Application) pluginBinding.getApplicationContext());
  ...
  public static void registerWith(Registrar registrar) {
        BluetoothClassicPlugin instance = new BluetoothClassicPlugin();
        Application application = null;
        if (registrar.context() != null) {
            application = (Application) (registrar.context().getApplicationContext());
        }
        instance.setup(registrar,null,application);
  ...
  private void setup(Registrar _registrar,final ActivityPluginBinding activityBinding, Application _context) {
    synchronized (initializationLock) {
      ...
      // Plugin
      {
          if (_registrar != null) {
              ...
              currentActivity = _registrar.activity();
          } else {
              // V2 embedding setup for activity listeners.
              messenger = this.pluginBinding.getBinaryMessenger();
              currentActivity = activityBinding.getActivity();
          }
          ...
          if (_registrar != null) {
            _registrar.addRequestPermissionsResultListener(this);
        } else {
      ...
      // State
      {
          ...
          stateChannel.setStreamHandler(new StreamHandler() {
              ...
              public void onListen(Object o, EventSink eventSink) {
                  ...
                  application.registerReceiver(stateReceiver, new IntentFilter(BluetoothAdapter.ACTION_STATE_CHANGED));
              }
              @Override
              public void onCancel(Object o) {
                  stateSink = null;
                  try {
                      application.unregisterReceiver(stateReceiver);
                  }
    ...
    public void onMethodCall(MethodCall call, Result result) {
        ...
        methodCallDispatching: switch (call.method) {
            ...
            case "openSettings":
                ContextCompat.startActivity(currentActivity, new Intent(android.provider.Settings.ACTION_BLUETOOTH_SETTINGS), null);
                result.success(null);
                break;
            ...
            case "requestEnable":
                if (!bluetoothAdapter.isEnabled()) {
                    ...
                    ActivityCompat.startActivityForResult(currentActivity, intent, REQUEST_ENABLE_BLUETOOTH, null);
                }
                else {
                    result.success(true);
                }
                ...
                if (address.equals("02:00:00:00:00:00")) {
                    ...
                    do {
                        ...
                        try {
                            ...
                            String value = android.provider.Settings.Secure.getString(application.getContentResolver(), "bluetooth_address");
                            if (value == null) {
            ...
            case "bondDevice": {
                ...
                application.registerReceiver(bondStateBroadcastReceiver, filter);
            ...
            case "pairingRequestHandlingEnable":
                ...
                application.registerReceiver(pairingRequestReceiver, filter);
                break;

            case "pairingRequestHandlingDisable":
                this.isPairingRequestHandlerSet = false;
                try {
                    application.unregisterReceiver(pairingRequestReceiver);
            ...
            case "startDiscovery":
                ensurePermissions(new EnsurePermissionsCallback() {
                    ...
                    public void onResult(boolean granted) {
                        ...
                        application.registerReceiver(discoveryReceiver, intent);
            ...
            case "requestDiscoverable": {
                ...
                pendingResultForActivityResult = result;
                ActivityCompat.startActivityForResult(currentActivity, intent, REQUEST_DISCOVERABLE_BLUETOOTH, null);
                break;
            }
  ...
  public boolean onViewDestroy(FlutterNativeView view) {
      ...
      try {
          if (bondStateBroadcastReceiver != null) {
              application.unregisterReceiver(bondStateBroadcastReceiver);
              bondStateBroadcastReceiver = null;
          }
      }
      catch (IllegalArgumentException ex) {
